...
clf = Pipeline(steps=[
    ...
    ('classifier', LogisticRegression(fit_intercept=False, solver = "newton-cg", penalty=None,
                                      max_iter=10000000, verbose=1))
])
...
# roc pivot
exp_roc = dx.fairness.roc_pivot(exp_roc, protected=X_test.SEX, privileged=0,
